...
const WebHostingPlan = () => {
  return (
    <div className="flex flex-col items-center w-3/4 rounded p-4 bg-gray-200 md:w-2/4 lg:w-1/4">
      ...
      <button className="mt-4 border-2 border-gray-900 text-gray-900 text-2xl font-bold rounded-full hover:text-white hover:bg-gray-900 transition p-1 w-full">
        BUY NOW
      </button>
    </div>
  );
